...
const salaryAssessmentSchema = new mongoose.Schema({
  offeredAmount: { type: String, required: true },
...
const analysisResultSchema = new mongoose.Schema({
  ...
  overallRiskScore: { type: Number, min: 1, max: 10, required: true },
  salaryAssessment: { type: salaryAssessmentSchema, required: true },
  negotiationScript: { type: String, required: true },
  topRedFlags: [{ type: String }],
});
