...
export default function Dashboard() {
  ...
  const handleAnalyze = async () => {
    ...
    if (tab === "text" && !text.trim()) {
      toast.error("Please paste your offer letter text");
      return;
    }
    ...
    try {
      const res =
        tab === "upload"
          ? await analysisAPI.analyzeFile(file)
          : await analysisAPI.analyzeText(text);
        ...
        <div>
          ...
          {tab === "upload" && (
            <div
              ...
              style={{
                border: `2px dashed ${
                  dragOver ? "var(--accent-light)" : "var(--border)"
                }`,
          ...
          {analyzing && (
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "var(--text-muted)" }}>
                  AI is analyzing your offer letter — this may take 10–20
                  seconds...
                </div>
              </div>
            </div>
          ...
          {user && !user.isPremium && (
            <div
              style={{
                ...
                padding: "20px",
                background:
                  "linear-gradient(135deg, var(--accent-dim), rgba(108,99,255,0.05))",
